...
static int ti_lmu_backlight_init(struct ti_lmu_bl_chip *chip)
{
	...
	/*L19 code for HQ-170139 by caogaojie at 2021/11/26 start*/
	regmap_write(regmap, 0x11, 0x01);
	regmap_write(regmap, 0x12, 0x01);
	/*L19 code for HQ-170139 by caogaojie at 2021/11/26 end*/
