...
#include "sc201cs_ofilm_mipiraw_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "sc201cs_ofilm_mipi_raw"
...
static imgsensor_info_struct imgsensor_info = { 
    .sensor_id = SC201CS_OFILM_DEPTH_SENSOR_ID,
   ...
   // .checksum_value = 0x221b1a41,        //checksum value for Camera Auto Test
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_MONO,    //+bug682590,zhanghengyuan.wt,ADD,2021/8/26,fix depth sc201cs output_dataformat
...
UINT32 SC201CS_OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    SC201CS_OFILM_MIPI_RAW_SensorInit    */
