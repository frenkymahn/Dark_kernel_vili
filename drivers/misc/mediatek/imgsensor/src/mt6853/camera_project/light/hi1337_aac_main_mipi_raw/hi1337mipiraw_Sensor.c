...
extern bool read_eeprom_hi1337(kal_uint16 addr, BYTE * data, kal_uint32 size);

#undef VENDOR_EDIT

#define USE_BURST_MODE 1
#define ENABLE_PDAF 1
#define AAC_VENDOR_ID 0x10
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1337_AAC_MAIN_SENSOR_ID,
	...
	.min_gain_iso = 50,
	/*L19 code for HQ-161200 by TianGuchen at 2022/01/04 end*/
	.exp_step = 1,
	.gain_step = 4, // 4*16=64
	.gain_type = 3,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if(vendor_id == AAC_VENDOR_ID){
					pr_err("aac vendor_id:  0x%x\n",vendor_id);
					return ERROR_NONE;
				}
			}
	...
	if ((*sensor_id != imgsensor_info.sensor_id) || (vendor_id != AAC_VENDOR_ID)) {
...
/*L19 code for HQ-172980 by huabinchen at 2022/01/13 end*/
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		read_eeprom_hi1337((kal_uint16)(*feature_data),
...
UINT32 HI1337_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /* HI1337_MIPI_RAW_SensorInit */
