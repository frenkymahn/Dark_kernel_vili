...
wl2866_ldo_pin_map_t wl2866_ldo_pin_map[] = {
	...
	{ IMGSENSOR_SENSOR_IDX_MAIN, IMGSENSOR_HW_PIN_DVDD, WL2866_LDO_DVDD1},//1.1V
...
/* L19 code for 190848 by caihongfei at 2022.03.09 start */
	{ IMGSENSOR_HW_PIN_STATE_LEVEL_1050, 0x4B},
	...
	enum IMGSENSOR_HW_PIN_STATE pin_state)
{
	...
	if (pin > IMGSENSOR_HW_PIN_DOVDD   ||
	    ...
	    pin_state > IMGSENSOR_HW_PIN_STATE_LEVEL_1050 ||
	    sensor_idx < 0)
		return ret;
