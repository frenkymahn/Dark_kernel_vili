...
static BYTE hi1337_eeprom_data[DATA_SIZE] = {0};
...
static bool _read_eeprom_1337(kal_uint16 addr, BYTE *data, kal_uint32 size)
{
	int i = 0;
	int index = 0;
	int offset = addr;
...
bool read_eeprom_hi1337_ofilm(kal_uint16 addr, BYTE *data, kal_uint32 size)
{
	BYTE af_pos[4];
