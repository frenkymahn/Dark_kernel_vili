...
#include "hi556_mipi_raw_Sensor.h"

#define PFX "hi556_mipi_raw_Sensor"
...
#define per_frame 1
/* L19 code for 161200 by caihongfei at 2021.12.28 start */
static struct imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HI556_OFILM_FRONT_SENSOR_ID,
	.checksum_value = 0x55e2a82f,
	.pre = {
		.pclk = 175934000,				//record different mode's pclk
		...
		.max_framerate = 300,
		.mipi_pixel_rate = 87967000,//440M x 2 / 10
	...
	.cap = {
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.max_framerate = 300,
		.mipi_pixel_rate = 175934000,//880M x 2 / 10
	},
	...
	.hs_video = {
		...
		.max_framerate = 1200,
		.mipi_pixel_rate = 43983500,//220M x 2 / 10
	},
    .slim_video = {
		.pclk = 175934000,
		.linelength = 2816,
...
/* L19 code for 161200 by caihongfei at 2021.12.28 end */
