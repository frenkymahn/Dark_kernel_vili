...
#ifndef _OV8856_AAC_MIPIRAW_SETTING_H_
#define _OV8856_AAC_MIPIRAW_SETTING_H_
#include "ov8856_aac_mipiraw_Sensor.h"
...
static void load_init_setting(void)
{
    ...
    pr_err("OV8856AACMIPIRAW load init ok!!!\n");
}

static void load_preview_setting(void)
{
    write_cmos_sensor(0x0302, 0x38);
    ...
    pr_err("OV8856AACMIPIRAW load preview ok!!!\n");
}

static void load_capture_setting(void)
{
    write_cmos_sensor(0x0302, 0x34);
    write_cmos_sensor(0x0303, 0x00);
    write_cmos_sensor(0x3501, 0x9a);
    write_cmos_sensor(0x3502, 0x20);
    write_cmos_sensor(0x366e, 0x10);
    ...
    pr_err("OV8856AACMIPIRAW load capture ok!!!\n");
}
...
static void load_video_setting(void)
{
    ...
    pr_err("OV8856AACMIPIRAW load video ok!!!\n");
}
...
static void load_hs_setting(void)
{
   write_cmos_sensor(0x0302, 0x38);
    ...
    pr_err("OV8856AACMIPIRAW load hs ok!!!\n");
}
...
static void load_slim_setting(void)
{
    ...
    pr_err("OV8856AACMIPIRAW load slim ok!!!\n");
}
