...
#include "gc5035_sunny_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC5035_SUNNY_FRONT_SENSOR_ID,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 240) { /* PIP */
		...
		write_cmos_sensor(0xf5, 0xe9);
		write_cmos_sensor(0xf6, 0x14);
		write_cmos_sensor(0xf8, 0x45); //write_cmos_sensor(0xf8, 0x49);
	}
	write_cmos_sensor(0xf9, 0x82);
	write_cmos_sensor(0xfa, 0x00);
	write_cmos_sensor(0xfc, 0x81);
