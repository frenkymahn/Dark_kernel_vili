...
#include "s5kjn1_ofilm_main_mipi_raw_Sensor.h"
...
#define PFX "S5KJN1OFILM_camera_sensor"
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_s5kjn1ofilm[] = {
...
static void sensor_init(void)
{
	...
	mdelay(10);
		...
		addr_data_pair_init_s5kjn1ofilm,
		sizeof(addr_data_pair_init_s5kjn1ofilm) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_s5kjn1ofilm[] = {
  0x6028,0x2400,
  0x602A,0x1A28,
  0x6F12,0x4C00,
  0x602A,0x065A,
...
static void preview_setting(void)
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_preview_s5kjn1ofilm,
		sizeof(addr_data_pair_preview_s5kjn1ofilm) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_s5kjn1ofilm[] = {
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
	0x602A,0x065A,
...
static void hs_video_setting(void) /// 120fps
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_hs_video_s5kjn1ofilm,
		sizeof(addr_data_pair_hs_video_s5kjn1ofilm) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_s5kjn1ofilm[] = {
	 0x6028,0x2400,
	 0x602A,0x1A28,
	 0x6F12,0x4C00,
	 0x602A,0x065A,
...
static void capture_setting(kal_uint16 currefps)
{
	LOG_INF("start\n");
        s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_capture_s5kjn1ofilm,
		sizeof(addr_data_pair_capture_s5kjn1ofilm) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_s5kjn1ofilm[] = {
  0x6028,0x2400,
  0x602A,0x1A28,
  0x6F12,0x4C00,
  0x602A,0x065A,
...
static void normal_video_setting(kal_uint16 currefps)  // 30fps
{
	...
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_normal_video_s5kjn1ofilm,
		sizeof(addr_data_pair_normal_video_s5kjn1ofilm) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_s5kjn1ofilm[] = {
	0x6028,0x2400,
	0x602A,0x1A28,
	0x6F12,0x4C00,
	0x602A,0x065A,
...
static void slim_video_setting(void) //60fps
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_slim_video_s5kjn1ofilm,
		sizeof(addr_data_pair_slim_video_s5kjn1ofilm) / sizeof(kal_uint16));
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_custom1_s5kjn1ofilm[] = {
	0x6028,0x2400,    
	0x602A,0x1A28,    
	0x6F12,0x4C00,    
	0x602A,0x065A,    
...
static void custom1_setting(void)
{
	LOG_INF("E\n");
	s5kjn1_multi_write_cmos_sensor(
		addr_data_pair_custom1_s5kjn1ofilm,
		sizeof(addr_data_pair_custom1_s5kjn1ofilm) / sizeof(kal_uint16));
}
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_info("s5kjn1ofilm_ofilm i2c 0x%x, sid 0x%x\n",
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_set_test_pattern_s5kjn1ofilm[] = {
	0x0200,0x0002,
	0x0202,0x0002,
	0x0204,0x0020,
	0x020E,0x0100,
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if (enable) {
		...
		s5kjn1_multi_write_cmos_sensor(
			addr_data_pair_set_test_pattern_s5kjn1ofilm,
			sizeof(addr_data_pair_set_test_pattern_s5kjn1ofilm) / sizeof(kal_uint16));
	} else {
...
{
	LOG_INF("S5KJN1_OFILM_MAIN_MIPI_RAW_SensorInit in\n");
