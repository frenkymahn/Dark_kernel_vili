...
#include "sc202cs_ofilm_mipiraw_Sensor.h"
...
static imgsensor_info_struct imgsensor_info = { 
    .sensor_id = SC202CS_OFILM_DEPTH_SENSOR_ID,
...
UINT32 SC202CS_OFILM_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT  **pfFunc)
{
