...
int ufs_read_desc_param(struct ufs_hba *hba, enum desc_idn desc_id, u8 desc_index, u8 param_offset,
...
extern int ufshcd_read_string_desc(struct ufs_hba *hba, u8 desc_index,
		u8 **buf, bool ascii);
